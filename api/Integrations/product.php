...
class PaymentGateway
{
     ...
     *
     * @param string $currency Moneda en la que se realiza el pago.
     *
     ...
     *
     * @param string $transactionId     Identificador único de la transacción que se utilizará para rastrear el proceso de pago a través de los diferentes sistemas y proveedores involucrados en el procesamiento de la transacción
     * @param float  $amount            Monto total de la transacción que será procesada, incluyendo todos los impuestos aplicables y las tarifas de procesamiento correspondientes al metodo de pago seleccionado
     * @param string $paymentMethodCode Código del metodo de pago seleccionado por el usuario, que puede incluir tarjetas de crédito, débito, billeteras digitales, transferencias bancarias u otros métodos de pago electrónicos disponibles en la plataforma
