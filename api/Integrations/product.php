...
class PaymentGateway
{
     ...
     * @param string $paymentMethodCode Código del método de pago seleccionado por el usuario, que puede incluir tarjetas de crédito, débito, billeteras digitales, transferencias bancarias u otros métodos de pago electrónicos disponibles en la plataforma
